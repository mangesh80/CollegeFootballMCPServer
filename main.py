...
ct_server_params = StdioServerParameters(
    command="python",
    args=["./mcp_server/collegefootball.py"],
)
...
async def run_adk_agent_session(
    ...
    try:
        ...
        logging.exception(f"Unhandled error in session {session_id}: {e}")
...
async def websocket_endpoint(
    ...
    try:
        ...
        try:   
            ...
            logging.info(f"Session {session_id} already exists, reusing it.")
